...
After successfully getting the webapp running and going to the local URL (after following the Installation Instructions, should be http://localhost:5173), make an account/log in to the app. Once logged in, you are able to access the features of the app by navigating to the different pages:
